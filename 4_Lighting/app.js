...
var camera1 = new Camera(vec3(0,1,3), vec3(1,0,0), vec3(0,1,0), vec3(0,0,1));
var light1 = new Light(vec3(0,0,0),vec3(0,1,-1),vec4(0.4,0.4,0.4,1.0), vec4(1,1,1,1), vec4(1,1,1,1),0,45,1);
...
window.onload = function init(){
    ...
    var shine = 100.0
    tri = new Cube(pos[0],pos[1],pos[2],scale,rot[0],rot[1],rot[2],amb,dif,spec,shine);
